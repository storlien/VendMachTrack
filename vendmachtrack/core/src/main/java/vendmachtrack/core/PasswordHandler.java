...
public final class PasswordHandler {
     ...
     */
    static String hashPassword(final String password) { // Parameter declared final
     ...
     */
    public static boolean verifyPassword(final String password) { // Parameter declared final
