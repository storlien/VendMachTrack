...
import gr2338.vendmachtrack.ui.controller.UserController;
...
public class UserControllerUITest extends ApplicationTest {
     ...
     * <li>Arrange: Mock a list of vending machines and their locations for
     * testing.</li>
     * <li>Arrange: Mock the inventory for a vending machine using predefined
     * values.</li>
     * <li>Arrange: Load the FXML file for the user application and set the mocked
     ...
     * remaining.
     * Set the selected machine ID to 1 on the JavaFX application thread using
     * {@link Platform#runLater(Runnable)}.</li>
     * <li>Act: Click on the "Cola" button, click on the "buy" button, and access
     * the button container and button row.</li>
     ...
     */
    @Test
    public void UserCOntroller_testBuy_OneItemRemaining() throws InterruptedException, ConnectException {
    ...
    public void UserController_testBuy_NoSelection() throws InterruptedException, ConnectException {
        ...
        assertEquals("Item name not valid", label.getText());
    }
